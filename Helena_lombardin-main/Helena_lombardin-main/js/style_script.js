...
function humanas_clique(){
      if (animacao_humanas.style.height == "280px"){
            
            animacao_humanas.style.height="170px"
...
function exatas_clique(){
      if (animacao_exatas.style.height == "280px"){
            ...
            animacao_x.style.marginTop="150px"
            animacao_exatas.style.height="280px"
